...
@pytest.fixture
def product():
    return Product('Апельсин', 'Красный ароматный апельсин', 69.99, 30), Product('Яблоко', 'Сочное яблоко', 79.90, 15)
...
def test___str__(product_1):
    assert f"Апельсин, 69.99 руб. Остаток: 30 шт."